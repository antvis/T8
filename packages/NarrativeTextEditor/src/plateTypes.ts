/**
 * FIXME plate 11.x 之后需要自己指定类型，编辑器暂不支持的类型之后可能增加，所以当前文件只做注释
 */
...
import { VariableInputNode, VariableNode } from './plugins/variable/types';
...
export type MyInlineElement = MyLinkElement | VariableInputNode | VariableNode;
// | MyMentionElement
