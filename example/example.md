...
The **premium segment** (devices over $800) showed _remarkable_ [resilience](trend_desc, assessment="positive"), growing by [5.8%](ratio_value, origin=0.058, assessment="positive"). [Average selling price](other_metric_value) was [$420](metric_value, origin=420, unit="USD").

## Key Findings

1. [Asia-Pacific](dim_value) remains the **largest market**
2. [Premium devices](dim_value) showed **strong growth**
3. Budget segment faced _headwinds_
