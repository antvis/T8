...
- [T8's Syntax](https://t8.antv.vision/schema/) - the Syntax and description for T8.
...
1. Prompt Template: A set of templates for prompting LLMs, see [prompt.md](./prompt.md) and [prompt.zh-CN.md](./prompt.zh-CN.md).
2. Some examples: [T8 Syntax Example](./example/example.md).
3. An example of an agent based on the [tbox](https://www.tbox.cn/): [Text Summary].
